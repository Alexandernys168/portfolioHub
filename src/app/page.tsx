        ...
        <div className="flex flex-col w-full max-w-[960px] flex-1 layout-content-container">
          <div className="@container">
            <div className="@[480px]:p-4">
              ...
              >
                ...
                <Link
                  href="/projects"
                  className="flex min-w-[84px] max-w-[480px] items-center justify-center overflow-hidden rounded-lg h-10 px-4 @[480px]:h-12 @[480px]:px-5 bg-[#f4c63d] text-[#1c180d] text-sm font-bold @[480px]:text-base"
                >
          ...
          <footer className="flex flex-col gap-6 px-5 py-10 text-center @container">
            <div className="flex flex-wrap items-center justify-center gap-6 @[480px]:flex-row @[480px]:justify-around">
              ...
              <Link href="/contact" className="text-[#9c8749] text-base min-w-40">
                Contact
              </Link>
              <Link href="/projects" className="text-[#9c8749] text-base min-w-40">
                Projects
              </Link>
            </div>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="#" aria-label="GitHub" className="text-[#9c8749]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <p className="text-[#9c8749] text-base">
